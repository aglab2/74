...
static struct KoopaTheQuickProperties sKoopaTheQuickProperties[] = {
    { DIALOG_005, DIALOG_007, KoopaBoB_path, { 3030, 4500, -4600 } },
    { DIALOG_009, DIALOG_031, KoopaTHI_path, { 819, -50, 3741 } },
};
...
static void koopa_the_quick_act_show_init_text(void) {
    ...
    if (response == DIALOG_RESPONSE_YES) {
        ...
        o->oPathedStartWaypoint = o->oPathedPrevWaypoint = (void*) sKoopaTheQuickProperties[o->oKoopaTheQuickRaceIndex].path;
